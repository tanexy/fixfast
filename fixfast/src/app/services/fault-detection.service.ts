...
export class FaultDetectionService {
  ...
  private generateRandomFault(): FaultDetection {
    const faultTypes = [
      { title: 'HVAC Temperature Alert', description: 'Temperature outside normal range in server room', location: 'Server Room A', severity: 'high' },
      { title: 'Network Connectivity Issue', description: 'Intermittent network drops detected', location: 'Building B - Floor 3', severity: 'medium' },
      { title: 'Lighting System Fault', description: 'Emergency lighting not functioning', location: 'Stairwell C', severity: 'critical' },
      { title: 'Water Leak Detection', description: 'Moisture sensors triggered in basement', location: 'Basement - Storage Area', severity: 'high' },
      { title: 'Power Supply Warning', description: 'UPS battery backup running low', location: 'Data Center', severity: 'medium' },
    ]
  ...
  private initializeSampleData(): void {
    this.detectedFaults = [
      ...
      { id:'fault_003',title: 'Network Connectivity Issue', description: 'Intermittent network drops detected', location: 'Building B - Floor 3', severity: 'medium',timestamp:new Date(Date.now() - 120000),status:'detected' },
      { id:'fault_004',title: 'Power Supply Warning', description: 'UPS battery backup running low', location: 'Data Center', severity: 'medium',timestamp:new Date(Date.now() - 300000),status:'detected' },
    ]
  }
}